(function () {
    ...
    const AutoShowTip = function (chart, option, interval, params, callback) {
        //对象属性存储
        ...
        chart.clearAutoShow = ()=>{
            autoShowInstance.clearAutoShow()
        }
    }
    ...
    const RadarAutoTip = function (target, option, interval, params) {
        this.config = {}
    ...
    if (typeof module !== 'undefined' && typeof exports === 'object') {
        module.exports = AutoShowTip
    } else if (typeof define === 'function' && define.amd) {
        define(function () {
            return AutoShowTip
        })
    } else {
        this.AutoShowTip = AutoShowTip
    }
}).call(function () {
